...
public class DMHandler {
    ...
    void SetProperties(){
        if (directMassage.isGroup){
            ...
            myBack=new ImageView(new Image("C:\\Users\\season\\Desktop\\Projrct\\last\\java-project-part2-main\\src\\main\\resources\\com\\example\\project_part2\\icon\\GroupBack.png"));
