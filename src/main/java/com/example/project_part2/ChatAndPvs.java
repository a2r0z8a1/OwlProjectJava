...
public class ChatAndPvs implements Initializable {
    ...
    @FXML
    private AnchorPane ChatAndPvsAnchor,SearchAnchor;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        //  String DMCode=DirectMassage.NewDirectMassage(Viewer.UserName,"aaaa");
      //  DirectMassage directMassage1=MAINInformation.mainInformation.directmassages.get("0");
