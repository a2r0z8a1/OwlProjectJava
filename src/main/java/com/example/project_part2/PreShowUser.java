...
public class PreShowUser {
    ...
    PreShowUser(User _user, double X, double Y, AnchorPane anchorPane){
        ...
        myBack=new ImageView(new Image("C:\\Users\\season\\Desktop\\Projrct\\last\\java-project-part2-main\\src\\main\\resources\\com\\example\\project_part2\\icon\\userbox.png"));
