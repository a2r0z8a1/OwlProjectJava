...
public class ShowMassageHandler {
    ...
    ShowMassageHandler(Massage _massage, double X, double Y,User user,Color color,boolean isColor){
        ...
        image=new Image("C:\\Users\\season\\Desktop\\Projrct\\last\\java-project-part2-main\\src\\main\\resources\\com\\example\\project_part2\\icon\\like.png");
        LikeImage=new ImageView(image);
        LikeImage.setFitHeight(25);
        LikeImage.setFitWidth(25);

        image=new Image("C:\\Users\\season\\Desktop\\Projrct\\last\\java-project-part2-main\\src\\main\\resources\\com\\example\\project_part2\\icon\\dislike.png");
        DisLikeImage=new ImageView(image);
        DisLikeImage.setFitHeight(25);
        DisLikeImage.setFitWidth(25);

        image=new Image("C:\\Users\\season\\Desktop\\Projrct\\last\\java-project-part2-main\\src\\main\\resources\\com\\example\\project_part2\\icon\\Reply.png");
        ReplyImage=new ImageView(image);
        ReplyImage.setFitHeight(25);
        ReplyImage.setFitWidth(25);

        image=new Image("C:\\Users\\season\\Desktop\\Projrct\\last\\java-project-part2-main\\src\\main\\resources\\com\\example\\project_part2\\icon\\forward.png");
        ForwardImage=new ImageView(image);
        ForwardImage.setFitHeight(25);
        ForwardImage.setFitWidth(25);

        image=new Image("C:\\Users\\season\\Desktop\\Projrct\\last\\java-project-part2-main\\src\\main\\resources\\com\\example\\project_part2\\icon\\moreoption.png");
